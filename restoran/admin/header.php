...
<body>
	...
	<div class="col-md-2">
		...
		<ul class="nav nav-pills nav-stacked">
			...
			<li><a href="barang.php"><span class="glyphicon glyphicon-briefcase"></span>  USER</a></li>
			<li><a href="barang_laku.php"><span class="glyphicon glyphicon-briefcase"></span>  MENU</a></li> 
            <li><a href="barang.php"><span class="glyphicon glyphicon-briefcase"></span>  MAKANAN</a></li>
            <li><a href="barang.php"><span class="glyphicon glyphicon-briefcase"></span>  PEMESANAN</a></li>			
